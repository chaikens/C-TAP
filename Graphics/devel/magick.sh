...
top_srcdir='/data/GIT/ImageMagick'
top_builddir='/data/GIT/ImageMagick'

MAGICK_CODER_MODULE_PATH='/data/GIT/ImageMagick/coders'
MAGICK_CONFIGURE_SRC_PATH='/data/GIT/ImageMagick/config'
MAGICK_CONFIGURE_BUILD_PATH='/data/GIT/ImageMagick/config'
MAGICK_FILTER_MODULE_PATH='/data/GIT/ImageMagick/filters'
DIRSEP=':'

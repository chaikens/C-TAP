...
FAST_FILESYS_DIR_IF_USED=/home/ctap/CTAPwork #"/media/seth/TerabyteSandisk/CTAP"
...
SLOW_MOVIE_DIR=/home/ctap/TM
movie_files=$(echo ${SLOW_MOVIE_DIR}/DS.mp4)
#movie_files=$(echo ${SLOW_MOVIE_DIR}/N*main_2025020600*.mp4)

...
#with 2 ffmpeg calls: first to insert frame numbers and decimate, second
# to add frame numbers into decimated movies.  But the latter isn't necessary
# since a movie ought to know what frame number it's at. (That's questionable.)

...
FAST_MOVIE_DIR=`pwd`/TMPMOVIES
#FAST_MOVIE_DIR=/data/GIT/C-TAP/TMPMOVIES
...
SLOW_MOVIE_DIR=/media/seth/BENCAM-COPY/2025-01-29
#movie_files=$(echo ${SLOW_MOVIE_DIR}/*main_20250117{18,19,20,21,22,23}*.mp4)
#movie_files=$(echo ${SLOW_MOVIE_DIR}/*main_20250122{18,19,20,21,22,23}*.mp4)

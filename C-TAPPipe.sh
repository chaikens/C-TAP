...
do
    ...
    #
    echo $0 calling MakeBabyMOV.sh script

    BABY_EXT="MOV" #the baby's name made by its mother, purposely in UPPER CASE.
    ./MakeBabyMOV.sh ${moviePrefix} --bmpsdir ${BITMAPS_DIR} ${RESULTS_DIR}/${RESULT_OF_1b_BASE} ${RESULTS_DIR}

    RET=$?
    echo MakeBabyMOV.sh returned $ret
    ...
    echo ${RESULTS_DIR}/${moviePrefix}.${BABY_EXT}

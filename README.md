...
There are no detailed instructions since this branch points to current development.

Read C-TAP-jobDS1HalfDecimated.sh

RESULTS-jobDS1HalfDecimated/ contains what should result from this.
